...
//        editor.apply();
        ...
        Glide.with(this).load(imgone).placeholder(R.mipmap.upload_bg).into(img1);
        Glide.with(this).load(imgtwo).placeholder(R.mipmap.upload_bg).into(img2);
        Glide.with(this).load(imgthree).placeholder(R.mipmap.upload_bg).into(img3);
        Glide.with(this).load(imgfour).placeholder(R.mipmap.upload_bg).into(img4);
